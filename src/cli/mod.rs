...
#[derive(Parser, Debug)]
#[command(name = "superwave-agent")]
#[command(
    about = "Secure personal AI assistant that protects your data and expands its capabilities"
)]
#[command(
    long_about = "Superwave Agent - AI platform for your business. Use 'superwave-agent <subcommand> --help' for details.\nExamples:\n  superwave-agent run  # Start the agent\n  superwave-agent config list  # List configs"
)]
#[command(version)]
...
pub enum Command {
    ...
    #[command(
        ...
        long_about = "Starts the Superwave agent in default mode.\nExample: superwave-agent run"
    )]
    Run,
    ...
    #[command(
        ...
        long_about = "Guides through initial configuration.\nExamples:\n  superwave-agent onboard --skip-auth  # Skip auth step\n  superwave-agent onboard --channels-only  # Reconfigure channels"
    )]
    Onboard {
    ...
    #[command(
        ...
        long_about = "Add, auth, list, or test MCP servers.\nExample: superwave-agent mcp add notion https://mcp.notion.com"
    )]
    Mcp(McpCommand),
    ...
    #[command(
        ...
        long_about = "Search, read, or write to memory.\nExample: superwave-agent memory search 'query'"
    )]
    ...
    #[command(
        ...
        long_about = "Approve or manage pairing requests.\nExamples:\n  superwave-agent pairing list telegram\n  superwave-agent pairing approve telegram ABC12345"
    )]
    ...
    #[command(
        ...
        long_about = "Generates shell completion scripts.\nExample: superwave-agent completion --shell bash > superwave.bash"
    )]
