...
pub struct SkillsConfig {
    ...
    pub enabled: bool,
    /// Directory containing user-placed skills (default: ~/.superwave/skills/).
    /// Skills here are loaded with `Trusted` trust level.
    pub local_dir: PathBuf,
    /// Directory containing registry-installed skills (default: ~/.superwave/installed_skills/).
...
/// Get the default user skills directory (~/.superwave/skills/).
fn default_skills_dir() -> PathBuf {
    ironclaw_base_dir().join("skills")
}

/// Get the default installed skills directory (~/.superwave/installed_skills/).
